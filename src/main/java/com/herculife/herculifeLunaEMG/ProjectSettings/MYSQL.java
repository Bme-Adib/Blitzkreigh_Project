...
import static com.herculife.herculifeLunaEMG.ProjectSettings.MyGoTo.*;
import static com.herculife.herculifeLunaEMG.ProjectSettings.Strings.LUNA_EMG_DATABASE;
...
//        Class.forName(DriverName);
        connection = DriverManager.getConnection("jdbc:mysql://localhost/" + LUNA_EMG_DATABASE + "?user=" + SQLUserName + "&password=" + SQLPassword + "&zeroDateTimeBehavior=convertToNull");
...
/*
create database Herculife_Luna_EMG_AG;
use Herculife_Luna_EMG_AG;
