...
import static com.herculife.herculifeLunaEMG.ProjectSettings.Strings.AboutLunaEMGPopUp;
import static com.herculife.herculifeLunaEMG.ProjectSettings.Strings.FxmlPre;

public class AboutLunaEMG implements Initializable {
    public static final String RESOURCE_NAME = FxmlPre + "AboutLunaEMG.fxml";
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        aboutTextField.setText(AboutLunaEMGPopUp);
    }
