...
import static com.herculife.herculifepelvictutor.ProjectSettings.MyGoTo.returnTrainingType;
...
//            }
    ...
    private void showInfo(int checkBoxIndex) {
        ...
        viewRelaxationCo.setText(String.valueOf(selectedTraining.getRelaxationCoordination()) + "%");
        viewDecontractionCo.setText(String.valueOf(selectedTraining.getDeContractionCoordination())+ "%");
        viewHoldingCo.setText(String.valueOf(selectedTraining.getHoldingCoordination())+ "%");
        viewDecontractionCo.setText(String.valueOf(selectedTraining.getDeContractionCoordination())+ "%");
        ...
        viewTrainingTarget.setText(String.valueOf(selectedTraining.getTrainingTarget())+ "%");
        viewRelaxationTime.setText(String.valueOf(selectedTraining.getRelaxationTime())+ " Sec");
        viewContractionTime.setText(String.valueOf(selectedTraining.getContractionTime())+ " Sec");
        viewHoldingTime.setText(String.valueOf(selectedTraining.getHoldingTime())+ " Sec");
        viewDecontractionTime.setText(String.valueOf(selectedTraining.getDeContractionTime())+ " Sec");
        ...
        viewPauses.setText(String.valueOf(selectedTraining.getPausesBetweenSets())+ " Sec");
